import 'package:sma/components/chart/extensions/color_extensions.dart';
...
class InputTab extends StatefulWidget {
  ...
  final Color dark = smaColors.contentColorCyan.darken(60);
  final Color normal = smaColors.contentColorCyan.darken(30);
  final Color light = smaColors.contentColorCyan;
              ...
              BarChartData(
                ...
                gridData: FlGridData(
                  ...
                  getDrawingHorizontalLine: (value) => FlLine(
                    color: smaColors.borderColor.withOpacity(0.1),
                    strokeWidth: 1,
                  ),
