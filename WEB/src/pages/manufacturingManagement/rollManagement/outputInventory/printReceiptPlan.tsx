...
interface PropsPrintReceiptPlan {
    branchInfo: cateBranch,
    dataReceiptVm: receiptVm,
    dataReceiptDetail: receiptDetailVm,
    dataLstIMEI: Array<receiptImei>
}
class PrintReceiptPlan extends React.Component<PropsPrintReceiptPlan>  {
    constructor(props: PropsPrintReceiptPlan) {
        super(props);
        ...
        return (
            <div className="print-container">
                ...
                <div className="inline-bolck w-100 text-center">
                    <h2 className="title-print">PHIẾU XUẤT HÀNG</h2>
                </div>
                ...
                <table className="table-detail-print">
                    <tbody>
                            ...
                            dataLstIMEI && dataLstIMEI.map((d, index) => (
                                <tr key={d.productID + d.steelType + d.width + d.thickness + dataReceiptVm.receiptNo + this.uuidv4(index)}>
                                    ...
                                    <td className="text-right">
                                        <NumericFormat value={d.quantity} displayType={'text'} thousandSeparator={true} prefix={''} />
                                    </td>
                                    <td className="text-right">
                                        <NumericFormat value={d.weight2} displayType={'text'} thousandSeparator={true} prefix={''} />
                                    </td>
                        ...
                        <tr>
                            ...
                            <td className="text-right">
                                <b>
                                    <NumericFormat value={tongsl} displayType={'text'} thousandSeparator={true} prefix={''} />
                                </b>
                            </td>
                            <td className="text-right">
                                <b>
                                    <NumericFormat value={tongkg} displayType={'text'} thousandSeparator={true} prefix={''} />
                                </b>
                            </td>
                            <td></td>
                        </tr>
...
export default PrintReceiptPlan;