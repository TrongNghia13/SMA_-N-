...
namespace DATA
{
    public partial class PlanDetailOutput
    {
        public decimal PlanDetailOutputID { get; set; }
        ...
        public virtual PlanDetailInput? PlanDetailInput { get; set; }
        public virtual PlanManufacturing? PlanManufacturing { get; set; }
    }
}
